...
The parameter is an object representing package information, containing the following properties:
...
* module: Module name
* srcdir: Source file directory; gtkdoc scans the source files in this directory to retrieve documentation information
* hdrs: List of header files; gtkdoc loads these header files to retrieve documentation information
* instdir: Installation directory. The default value is "share/doc/gtkdoc-PACKAGE-MODULE", where PACKAGE is the package name and MODULE is the module name
* formats: List of output documentation formats, which can include "html", "man", or "pdf". The default value is "html"

Example:
```
//Generate document of "MyModule"
gtkdoc({
    module: "MyModule"
    srcdir: "src"
    hdrs: [
    ...
    //Generate "man" and "HTML" document
    formats: [
        "man"
        "html"
    ]
...
|prod|Generate binary products that need to be installed|
